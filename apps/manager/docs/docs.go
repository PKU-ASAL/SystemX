...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "SysArmor Team",
            "url": "https://sysarmor.com/support",
            "email": "support@sysarmor.com"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/models.ProbeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ProbeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/events/collectors/{collector_id}": {
            "get": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "系统健康状态",
                        "schema": {
                            "$ref": "#/definitions/health.SystemHealthStatus"
                        }
                    },
                    "503": {
                        "description": "系统不健康",
        ...
        "/resources/configs/{deployment_type}/{config_name}": {
            "get": {
        ...
        "/resources/scripts/{deployment_type}/{script_name}": {
            "get": {
        ...
        "/services/flink/jobs/{job_id}/metrics": {
            "get": {
        ...
        "/services/flink/taskmanagers/overview": {
            "get": {
        ...
        "/services/kafka/brokers/overview": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Brokers 概览信息",
                        "schema": {
                            "$ref": "#/definitions/kafka.BrokersOverviewResponse"
                        }
                    },
                    "500": {
                        "description": "服务器内部错误",
        ...
        "/services/kafka/consumer-groups": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Consumer Groups 信息",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/services/kafka/consumer-groups/{group}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Consumer Group 详细信息",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Consumer Group 不存在",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/services/kafka/topics": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建 Topic 请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kafka.CreateTopicRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Topic 创建成功",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/services/kafka/topics/overview": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Topics 概览信息",
                        "schema": {
                            "$ref": "#/definitions/kafka.TopicsOverviewResponse"
                        }
                    },
                    "500": {
                        "description": "服务器内部错误",
        ...
        "/services/kafka/topics/{topic}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Topic 详细信息（增强版）",
                        "schema": {
                            "$ref": "#/definitions/kafka.TopicDetailsResponse"
                        }
                    },
                    "404": {
        ...
        "/services/kafka/topics/{topic}/config": {
            "get": {
        ...
        "/services/kafka/topics/{topic}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "消息数量限制，默认为10，最大100",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "起始偏移量，可以是数字或'earliest'/'latest'",
                        "name": "offset",
                        "in": "query"
                    }
                ],
        ...
        "/services/kafka/topics/{topic}/metrics": {
            "get": {
        ...
        "/services/opensearch/cluster/health": {
            "get": {
        ...
        "/services/opensearch/cluster/stats": {
            "get": {
        ...
        "/services/opensearch/events/aggregations": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "索引模式，默认为 sysarmor-events-*",
                        "name": "index",
                        "in": "query"
                    }
                ],
        ...
        "/services/opensearch/events/by-source": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "返回结果数量，默认为10，最大100",
                        "name": "size",
                        "in": "query"
                    }
                ],
        ...
        "/services/opensearch/events/high-risk": {
            "get": {
        ...
        "/services/opensearch/events/recent": {
            "get": {
        ...
        "/services/opensearch/events/search": {
            "get": {
        ...
        "/services/opensearch/events/threats": {
            "get": {
        ...
        "/services/opensearch/events/time-range": {
            "get": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.WazuhAgentListResponse"
                        }
                    },
                    "500": {
                        "description": "内部错误",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WazuhAgent"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WazuhSearchQuery"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.WazuhConfigResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "health.SystemHealthStatus": {
            ...
            "properties": {
                ...
                "components": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/health.SystemComponentHealth"
                    }
                },
                "healthy": {
                    "type": "boolean"
                ...
                "summary": {
                    "$ref": "#/definitions/health.SystemHealthSummary"
                },
                "workers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/health.WorkerHealthResult"
                    }
                }
            }
        },
        ...
        "health.WorkerHealthResult": {
            ...
            "properties": {
                ...
                "components": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/health.WorkerComponents"
                        }
                    ]
                },
                "error": {
                ...
                "metrics": {
                    "$ref": "#/definitions/health.WorkerMetrics"
                },
                "name": {
                    "type": "string"
                },
        ...
        "health.WorkerMetrics": {
            ...
            "properties": {
                ...
                "data_sources": {
                    "description": "数据源统计 (便于理解数据来源)",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/health.ComponentMetrics"
                    }
                },
                "errors_total": {
                    "description": "错误和性能指标",
                ...
                "events_received": {
                    "description": "数据指标 (只统计 source 组件)",
                    "type": "integer"
                },
        ...
        "kafka.BrokerOverviewItem": {
            ...
            "properties": {
                ...
                "jvm_stats": {
                    "$ref": "#/definitions/kafka.JVMStats"
                },
                "leader_count": {
                    "type": "integer"
                },
                "network_stats": {
                    "$ref": "#/definitions/kafka.NetworkStats"
                },
                "partition_count": {
                    "type": "integer"
                },
        ...
        "kafka.BrokersOverviewResponse": {
            "type": "object",
            "properties": {
                "brokers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kafka.BrokerOverviewItem"
                    }
                },
                "cluster": {
                    "$ref": "#/definitions/kafka.ClusterOverviewInfo"
                }
            }
        },
        "kafka.ClusterOverviewInfo": {
            "type": "object",
            "properties": {
                "broker_count": {
                    "type": "integer"
        ...
        "kafka.TopicDetailsResponse": {
            "type": "object",
            "properties": {
                "metrics": {
                    "$ref": "#/definitions/kafka.TopicMetricsInfo"
                },
                "overview": {
                    "$ref": "#/definitions/kafka.TopicOverviewInfo"
                },
                "partitions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kafka.PartitionDetailInfo"
                    }
                }
            }
        },
        "kafka.TopicMetricsInfo": {
            "type": "object",
            "properties": {
                "bytes_per_sec": {
                    "type": "number"
        ...
        "kafka.TopicsOverviewResponse": {
            "type": "object",
            "properties": {
                "summary": {
                    "$ref": "#/definitions/kafka.TopicsSummary"
                },
                "topics": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/kafka.TopicOverviewItem"
                    }
                }
            }
        },
        ...
        "models.CollectorMetadata": {
            "type": "object",
            "properties": {
                "datacenter": {
                    "description": "数据中心，如 \"dc1\", \"aws-us-east\"",
                    "type": "string"
                },
                "description": {
                    "description": "描述信息",
                ...
                "environment": {
                    "description": "环境标识，如 \"prod\", \"staging\", \"dev\"",
                    "type": "string"
                },
                "group": {
                    "description": "分组名称，如 \"web-servers\", \"db-cluster\"",
                    "type": "string"
                },
                "owner": {
                    "description": "负责人/团队",
                ...
                "purpose": {
                    "description": "用途，如 \"web-server\", \"database\", \"cache\"",
                    "type": "string"
                },
                "region": {
                    "description": "地域信息，如 \"us-east-1\", \"beijing\"",
                    "type": "string"
                },
                "tags": {
                    "description": "标签列表，如 [\"web\", \"production\", \"critical\"]",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.RegisterRequest": {
            ...
            "properties": {
                ...
                "metadata": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.CollectorMetadata"
                        }
                    ]
                },
                "os_type": {
        ...
        "models.WazuhAgent": {
            ...
            "properties": {
                ...
                "os": {
                    "$ref": "#/definitions/models.WazuhOSInfo"
                },
                "register_ip": {
                    "type": "string"
                },
        ...
        "models.WazuhAgentListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.WazuhAgentListData"
                },
                "error": {
                    "type": "integer"
                },
        ...
        "models.WazuhConfigResponse": {
            "type": "object",
            "properties": {
                "indexer": {
                    "$ref": "#/definitions/models.WazuhIndexerConfigInfo"
                },
                "manager": {
                    "$ref": "#/definitions/models.WazuhManagerConfigInfo"
                },
                "message": {
                    "type": "string"
                },
        ...
        "models.WazuhSearchQuery": {
            ...
            "properties": {
                ...
                "index_type": {
                    "description": "alerts or archives",
                    "type": "string"
                },
                "query": {
                    "description": "支持字符串或复杂DSL"
                },
                "rule_id": {
                    "description": "规则ID",
                    "type": "string"
