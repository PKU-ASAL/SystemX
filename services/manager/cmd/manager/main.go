...
import (
	...
	"github.com/sysarmor/sysarmor/services/manager/internal/api/handlers"
	...
	// _ "github.com/sysarmor/sysarmor/services/manager/docs" // This will be generated by swag init
)
...
func main() {
	...
	if opensearchHandler != nil {
		opensearch := api.Group("/opensearch")
		{
			// 集群管理
