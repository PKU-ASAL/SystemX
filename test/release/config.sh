...
ATTACK_SCRIPT="${ATTACK_SCRIPT:-$RELEASE_DIR/attacks/web-runtime-spawns-shell.sh}"
RESTART_TEST="${RESTART_TEST:-0}"
FRESH_DOWNLOAD="${FRESH_DOWNLOAD:-1}"
RELEASE_PROXY_URL="${RELEASE_PROXY_URL-https://gh-proxy.org}"

EXPECTED_BEHAVIOR="${EXPECTED_BEHAVIOR:-process.exec}"
EXPECTED_SIGNAL_RULE="${EXPECTED_SIGNAL_RULE:-web_runtime_spawns_shell}"
EXPECTED_SIGNAL_SEVERITY="${EXPECTED_SIGNAL_SEVERITY:-high}"
HEALTH_TIMEOUT="${HEALTH_TIMEOUT:-90}"
DETECTION_TIMEOUT="${DETECTION_TIMEOUT:-60}"
STOP_TIMEOUT="${STOP_TIMEOUT:-20}"
ISOLATION_SETTLE_SECONDS="${ISOLATION_SETTLE_SECONDS:-3}"
