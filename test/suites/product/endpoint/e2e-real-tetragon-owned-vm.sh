...
EVENT_CURSOR="$(jq -r '.streams.eventNewestSequence // 0' "$RESULTS/e2e-agent-real-tetragon-owned-vm.health-before-attack.json")"
SIGNAL_CURSOR="$(jq -r '.streams.signalNewestSequence // 0' "$RESULTS/e2e-agent-real-tetragon-owned-vm.health-before-attack.json")"
