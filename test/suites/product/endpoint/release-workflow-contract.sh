...
grep -Fq "github.ref != 'refs/heads/main'" "$stable"
grep -Fq 'production-release' "$stable"
grep -Fq 'SYSARMOR_ARTIFACT_SIGNING_KEY_PEM' "$stable"
grep -Fq 'SYSARMOR_CONTENT_SIGNING_KEY_PEM' "$stable"
grep -Fq 'SYSARMOR_CONTENT_KEY_ID' "$stable"
