...
| `reliability` | Spool/WAL, outage, restart, shutdown, backpressure behavior. | `e2e-spool.sh`, `e2e-outage-soak.sh`, `e2e-shutdown.sh`, `e2e-backpressure.sh` |
| `storage` | Postgres/store projection and query contract. | `e2e-postgres.sh` |
