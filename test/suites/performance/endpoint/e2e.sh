...
OUT_DIR="$RESULTS/performance-endpoint-e2e/$RUN_ID"
REC_RUN_ID="performance-endpoint-e2e/$RUN_ID"
...
echo "[performance-endpoint-e2e] output: $OUT_DIR env=$VM_ENV scenario=$SCENARIO"
...
echo "[performance-endpoint-e2e] summary written to $OUT_DIR/summary.json"
