...
const file_api_proto_analytics_v1_agentgateway_proto_rawDesc = "" +
	"\n" +
	")api/proto/analytics/v1/agentgateway.proto\x12\x15sysarmor.analytics.v1\x1a\x1eapi/proto/event/v1/event.proto\x1a api/proto/signal/v1/signal.proto\"w\n" +
	"\n" +
	"AgentHello\x12\x19\n" +
	...
	"\fpayload_json\x18\x02 \x01(\fR\vpayloadJson2\xb4\x01\n" +
	"\fAgentGateway\x12N\n" +
...
var (
	...
	file_api_proto_analytics_v1_agentgateway_proto_rawDescData []byte
)
...
func file_api_proto_analytics_v1_agentgateway_proto_rawDescGZIP() []byte {
	file_api_proto_analytics_v1_agentgateway_proto_rawDescOnce.Do(func() {
		file_api_proto_analytics_v1_agentgateway_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_analytics_v1_agentgateway_proto_rawDesc), len(file_api_proto_analytics_v1_agentgateway_proto_rawDesc)))
	})
...
var file_api_proto_analytics_v1_agentgateway_proto_goTypes = []any{
...
func file_api_proto_analytics_v1_agentgateway_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_analytics_v1_agentgateway_proto_rawDesc), len(file_api_proto_analytics_v1_agentgateway_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
