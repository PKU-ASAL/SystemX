      ...
      className={composeRenderProps(
        ...
        (className, { isFocusVisible, isPressed, isHovered, isDisabled }) =>
          twMerge(
            ...
            isCurrent &&
              "bg-(--sidebar-current-bg) font-medium text-(--sidebar-current-fg) hover:bg-(--sidebar-current-bg) hover:text-(--sidebar-current-fg) [&_.text-muted-fg]:text-(--sidebar-current-fg)/80 [&_svg:not([class*='text-'])]:text-(--sidebar-current-fg) hover:[&_svg:not([class*='text-'])]:text-(--sidebar-current-fg)",
...
type SidebarTreeProps<T extends object> = TreeProps<T>
